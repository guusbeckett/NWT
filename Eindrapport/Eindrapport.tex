...
\\Aangezien de imageserver zijn verantwoordelijkheden zijn verwerkt in de gateway vallen de requirements van de imageserver nu onder de gateway. De gateway moet nu dan ook een TFTP-server, NFS-server en PXE-bootserver hebben.
